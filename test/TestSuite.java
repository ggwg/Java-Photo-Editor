...
public class TestSuite {
  ...
  //my Additional Tests
  @Test
  public void rotate360() throws IOException {
    assertEquals(
            Utils.loadPicture("images/bwpatterns64x64.png"),
            TestSuiteHelper.runMain(
                    tmpFolder, "rotate", "360", "images/bwpatterns64x64.png"));
  }

  @Test
  public void blurImageTest() throws IOException {
    assertEquals(
            Utils.loadPicture("images/4imageblur.png"),
            TestSuiteHelper.runMain(
                    tmpFolder, "blend", "images/black64x64.png", "images/red64x64.png", "images/rainbow64x64doc.png", "images/white64x64.png"));
  }

  @Test
  public void bigImageInvert() throws IOException {
    assertEquals(
            Utils.loadPicture("images/t1invert.png"),
            TestSuiteHelper.runMain(
                    tmpFolder, "invert", "images/t1.png"));
  }
}
